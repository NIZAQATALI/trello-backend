...
router.delete('/:workspaceId/:boardId/:listId/:cardId/delete-card',   auth.verifyToken,cardController.deleteById); router.put('/:workspaceId/:boardId/:listId/:cardId/update-cover',  auth.verifyToken, cardController.updateCover);
router.put('/:workspaceId/:boardId/:listId/:cardId/:attachmentId/update-attachment',   auth.verifyToken,cardController.updateAttachment);
router.delete('/:workspaceId/:boardId/:listId/:cardId/:attachmentId/delete-attachment',  auth.verifyToken, cardController.deleteAttachment); 
